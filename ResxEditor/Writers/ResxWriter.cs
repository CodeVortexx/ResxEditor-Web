...
public static class ResxWriter
{
    ...
    """;
    private const string FileEnd = "</root>";
    ...
    public static string Write(ResxDocument document)
    {
        ...
        stringBuilder.AppendLine(HeaderContent);

        // Write data
        foreach (var (key, value) in document.Values)
        {
            stringBuilder.AppendLine($"  <data name=\"{key}\" xml:space=\"preserve\">");
            stringBuilder.AppendLine($"    <value>{value}</value>");
